...
def test_scf_incar_checks(test_dir, object_name):
    ...
    list_of_checks = [
        ...
        {"err_msg": "LMAXPAW", "should_pass": False, "vasprun": {"LMAXPAW": 0}, "incar": {}},
        {
            "err_msg": "NLSPLINE",
            "should_pass": False,
            "vasprun": {"NLSPLINE": True},
            "incar": {},
        },
        {
            "err_msg": "ADDGRID",
            "should_pass": False,
            "vasprun": {"ADDGRID": True},
            "incar": {},
        },
        {
            "err_msg": "LHFCALC",
            "should_pass": False,
            "vasprun": {"LHFCALC": True},
            "incar": {},
        },
        ...
        {"err_msg": "SCALEE", "should_pass": False, "vasprun": {"SCALEE": 0.9}, "incar": {}},
        {
            ...
            "should_pass": False,
            "vasprun": {"LNONCOLLINEAR": True},
            "incar": {},
        },
        {
            "err_msg": "LSORBIT",
            "should_pass": False,
            "vasprun": {"LSORBIT": True},
            "incar": {},
        },
        ...
        },  # EBREAK check depends on incar, not vasprun.xml parameters
        {
            "err_msg": "GGA_COMPAT",
            "should_pass": False,
            "vasprun": {"GGA_COMPAT": False},
            "incar": {},
        },
        {
            "err_msg": "ICORELEVEL",
            "should_pass": False,
            "vasprun": {"ICORELEVEL": 1},
            "incar": {},
        },
        ...
        {"err_msg": "LBERRY", "should_pass": False, "vasprun": {"LBERRY": True}, "incar": {}},
        {
            "err_msg": "LCALCEPS",
            "should_pass": False,
            "vasprun": {"LCALCEPS": True},
            "incar": {},
        },
        {
            "err_msg": "LCALCPOL",
            "should_pass": False,
            "vasprun": {"LCALCPOL": True},
            "incar": {},
        },
        {
            "err_msg": "LHYPERFINE",
            "should_pass": False,
            "vasprun": {"LHYPERFINE": True},
            "incar": {},
        },
        {
            "err_msg": "LKPOINTS_OPT",
            "should_pass": False,
            "vasprun": {"LKPOINTS_OPT": True},
            "incar": {},
        },
        ...
        {"err_msg": "LMP2LT", "should_pass": False, "vasprun": {"LMP2LT": True}, "incar": {}},
        {
            "err_msg": "LSMP2LT",
            "should_pass": False,
            "vasprun": {"LSMP2LT": True},
            "incar": {},
        },
        {
            "err_msg": "LOCPROJ",
            "should_pass": False,
            "vasprun": {"LOCPROJ": "1 : s : Hy"},
            "incar": {},
        },
        {"err_msg": "LRPA", "should_pass": False, "vasprun": {"LRPA": True}, "incar": {}},
        {
            "err_msg": "LSPECTRAL",
            "should_pass": False,
            "vasprun": {"LSPECTRAL": True},
            "incar": {},
        },
        {
            "err_msg": "LSUBROT",
            "should_pass": False,
            "vasprun": {"LSUBROT": True},
            "incar": {},
        },
        {
            "err_msg": "ML_LMLFF",
            "should_pass": False,
            "vasprun": {"ML_LMLFF": True},
            "incar": {},
        },
        ...
        {"err_msg": "LASPH", "should_pass": False, "vasprun": {"LASPH": False}, "incar": {}},
        {
            "err_msg": "LCORR",
            "should_pass": False,
            "vasprun": {"LCORR": False, "IALGO": 38},
            "incar": {},
        },
        {
            "err_msg": "LCORR",
            "should_pass": True,
            "vasprun": {"LCORR": False, "IALGO": 58},
            "incar": {},
        },
        ...
        {"err_msg": "ISYM", "should_pass": False, "vasprun": {"ISYM": 3}, "incar": {}},
        {
            "err_msg": "ISYM",
            "should_pass": True,
            "vasprun": {"ISYM": 3, "LHFCALC": True},
            "incar": {},
        },
        {
            "err_msg": "SYMPREC",
            "should_pass": False,
            "vasprun": {"SYMPREC": 1e-2},
            "incar": {},
        },
        {
            "err_msg": "LDAUU",
